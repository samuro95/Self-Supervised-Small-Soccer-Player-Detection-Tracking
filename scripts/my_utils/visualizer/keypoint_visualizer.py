...
sys.path.append(os.path.abspath("/home/u176443/Documents/ARPE/lighttrack/utils/"))
...
def show_skeleton(keypoints_list,img):
    for keypoints in keypoints_list :
        #print(keypoints)
        joints = reshape_keypoints_into_joints(keypoints)
        img = show_poses_from_python_data(img, joints, joint_pairs, joint_names)
    return(img)
